...
class Mage_Adminhtml_Block_Sales_Invoice_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('invoices', array(
             'label'=> Mage::helper('sales')->__('Invoice Totals Report'),
             'url'  => $this->getUrl('*/sales_order_export/invoices'),
        ));

        $this->getMassactionBlock()->addItem('invoicesitems', array(
             'label'=> Mage::helper('sales')->__('Invoice Items Report'),
             'url'  => $this->getUrl('*/sales_order_export/invoicesitems'),
        ));
