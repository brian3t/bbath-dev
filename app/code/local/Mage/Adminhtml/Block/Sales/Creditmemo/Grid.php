...
class Mage_Adminhtml_Block_Sales_Creditmemo_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('credits', array(
             'label'=> Mage::helper('sales')->__('Credit Memo Totals Report'),
             'url'  => $this->getUrl('*/sales_order_export/credits'),
        ));
        
        $this->getMassactionBlock()->addItem('creditsitems', array(
             'label'=> Mage::helper('sales')->__('Credit Memo Items Report'),
             'url'  => $this->getUrl('*/sales_order_export/creditsitems'),
        ));
