...
class Eternal_Venedor_Model_Import_Blocks extends Mage_Core_Model_Abstract
{
    private $_importPath;
    ...
    public function importBlockItems($modelString, $itemContainerNodeString, $overwrite = false)
    {
        try
        {
