...
class Eternal_AjaxFilter_CatalogSearch_ResultController extends Mage_CatalogSearch_ResultController
{
    ...
    public function indexAction()
    {
        ...
        if($this->getRequest()->isXmlHttpRequest()){ 
            ...
            if ($this->getLayout()->getBlock('catalogsearch.rightnav'))
                $viewpanel = $this->getLayout()->getBlock('catalogsearch.rightnav')->toHtml(); //Get the new Layered Manu
            if ($this->getLayout()->getBlock('search_result_list'))
