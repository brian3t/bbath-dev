...
class Eternal_AjaxFilter_Catalog_CategoryController extends Mage_Catalog_CategoryController
{
    ...
    public function viewAction()
    {
        if($this->getRequest()->isXmlHttpRequest()){ //Check if it was an AJAX request
            ...
            else if ($this->getLayout()->getBlock('catalog.rightnav'))
                $viewpanel = $this->getLayout()->getBlock('catalog.rightnav')->toHtml(); // Generate New Layered Navigation Menu
