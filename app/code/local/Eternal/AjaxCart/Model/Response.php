...
class Eternal_AjaxCart_Model_Response extends Mage_Catalog_Block_Product_Abstract {
    ...
    public function addUpdatedBlocks(&$_response) {
        $updated_blocks = unserialize(Mage::getStoreConfig('eternal_ajaxcart/general/update_blocks'));
    ...
    public function addConfigurableOptionsBlock(&$_response) {
        ...
        $layout->getUpdate()->addHandle('eternal_ajaxcart_configurable_options');
        
        if ($_product->getTypeId() == 'bundle')
            $layout->getUpdate()->addHandle('eternal_ajaxcart_bundle_options');        
        ...
        $value = $layout->getBlock('eternal_ajaxcart.configurable.options');        
    ...
    public function addGroupProductItemsBlock(&$_response) {
        ...
        $layout->getUpdate()->addHandle('eternal_ajaxcart_grouped_options');
        ...
        $value = $layout->getBlock('eternal_ajaxcart.grouped.options');
