<?php
class Eternal_AjaxCart_Block_Adminhtml_Url extends Mage_Adminhtml_Block_System_Config_Form_Field {
    ...
    protected function _getHeaderHtml() {
        $output = '<tr>';
        $output .= '<th style="padding: 2px;">';
        $output .= Mage::helper('eternal_ajaxcart')->__('ID/Class selector of block to be updated');
        $output .= '</th>';
        $output .= '<th style="padding: 2px;">';
        $output .= Mage::helper('eternal_ajaxcart')->__('Layout Update Block name');
        $output .= '<br/>';
        $output .= Mage::helper('eternal_ajaxcart')->__('(should be same as in XML)');
        $output .= '</th>';
        $output .= '<th>&nbsp;</th>';
        $output .= '</tr>';
        return $output;
