...
class Eternal_AjaxCart_Checkout_CartController extends Mage_Checkout_CartController {
    ...
    public function addAction() {
        ...
        try {
            ...
            if ($this->getRequest()->getParam('options') == 'cart') {
                $_response->setRedirect($url.'?options=cart');
            }
