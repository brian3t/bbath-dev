 ...
 * File path:   app/code/local/Aitoc/Aitpermissions/Block/Rewrite/AdminPermissionsButtons.data.php
 * Copyright:   (c) 2012 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitpermissions')){ hwwjqhZqcZkwager('198aec3cc1ae747cbefc9478282a051f'); ?><?php
/**
 * Magento
 *
 * NOTICE OF LICENSE
...
class Aitoc_Aitpermissions_Block_Rewrite_AdminPermissionsButtons extends Mage_Adminhtml_Block_Permissions_Buttons
{
    ...
    {
        $this->setChild('duplicateButton',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'     => Mage::helper('adminhtml')->__('Duplicate Role'),
                    'onclick'   => 'window.location.href=\''.$this->getUrl('aitpermissions/adminhtml_role/duplicate/', array('rid' => $this->getRequest()->getParam('rid'))).'\'',
                    'class' => 'add'
                ))
        );
