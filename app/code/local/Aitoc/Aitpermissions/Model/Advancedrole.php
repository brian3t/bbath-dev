 ...
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitpermissions')){ IppacokcTkMpEjZP('5dfd587af29eb7b3d8180f087bcbc137'); ?><?php
/**
...
class Aitoc_Aitpermissions_Model_Advancedrole extends Mage_Core_Model_Abstract
{
    ...
    public function getWebsiteCategories()
    {
        ...
        {
            $groupCollection = Mage::getModel('core/store_group')->getCollection()->addFieldToFilter('main_table.group_id', array('in' => $this->getStoreId()))->load();
        }
        else
