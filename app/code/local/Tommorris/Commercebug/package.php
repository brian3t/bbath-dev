<?php
	class Commercebug_Packager
	{
		...
		{
			$string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Tommorris_Commercebug><active>true</active><codePool>local</codePool></Tommorris_Commercebug></modules></config>';
			$string = str_replace('Tommorris_', $this->namespace . '_',$string);
