<?php 
	class Tommorris_Commercebug_Model_Collectorblocksandlayout extends Tommorris_Commercebug_Model_Observingcollector
	{
		...
		{		
			...
			foreach($this->_blocks as $block)
			{
				...
				if(strpos($class,'Tommorris_Commercebug') === 0)
				{
					continue;
				}
