...
class Magebuzz_Dealerlocator_Block_Adminhtml_Dealerlocator_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $this->addColumn('dealerlocator_id', array(
      ...
      $this->addColumn('email', array(
          'header'    => Mage::helper('dealerlocator')->__('Email'),
          'align'     =>'left',
          'index'     => 'email',
      ));
	  
	  $this->addColumn('website', array(
          'header'    => Mage::helper('dealerlocator')->__('Website'),
          'align'     =>'left',
          'index'     => 'website',
      ));
	  
      $this->addColumn('phone', array(
          'header'    => Mage::helper('dealerlocator')->__('Phone'),
          'align'     =>'left',
          'index'     => 'phone',
      ));
	  
	  $this->addColumn('postal_code', array(
          'header'    => Mage::helper('dealerlocator')->__('Postal Code'),
          'align'     =>'left',
          'index'     => 'postal_code',
      ));
	  ...
	  $this->addColumn('note', array(
          'header'    => Mage::helper('dealerlocator')->__('Note'),
          'align'     =>'left',
          'index'     => 'note',
      ));
        ...
        $this->addColumn('action',
            array(
                'header'    =>  Mage::helper('dealerlocator')->__('Action'),
                'width'     => '100',
                'type'      => 'action',
                'getter'    => 'getId',
                'actions'   => array(
                    array(
                        'caption'   => Mage::helper('dealerlocator')->__('Edit'),
                        'url'       => array('base'=> '*/*/edit'),
                        'field'     => 'id'
                    )
                ),
    ...
    protected function _prepareMassaction()
    {
         ...
         $this->getMassactionBlock()->addItem('delete', array(
              'label'    => Mage::helper('dealerlocator')->__('Delete'),
              'url'      => $this->getUrl('*/*/massDelete'),
              'confirm'  => Mage::helper('dealerlocator')->__('Are you sure?')
         ));
         
         $this->getMassactionBlock()->addItem('geocode', array(
              'label'    => Mage::helper('dealerlocator')->__('Geocode'),
              'url'      => $this->getUrl('*/*/massGeocode')
         ));
        ...
        $this->getMassactionBlock()->addItem('status', array(
             'label'=> Mage::helper('dealerlocator')->__('Change status'),
