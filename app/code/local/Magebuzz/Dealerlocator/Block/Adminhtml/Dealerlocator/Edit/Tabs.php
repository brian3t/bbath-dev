...
class Magebuzz_Dealerlocator_Block_Adminhtml_Dealerlocator_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
      $this->addTab('form_section', array(
          'label'     => Mage::helper('dealerlocator')->__('Dealer Information'),
          'title'     => Mage::helper('dealerlocator')->__('Dealer Information'),
          'content'   => $this->getLayout()->createBlock('dealerlocator/adminhtml_dealerlocator_edit_tab_form')->toHtml(),
      ));
