 ...
 * */
class Bluejalappeno_Orderexport_Model_Export_Credits extends Bluejalappeno_Orderexport_Model_Export_Abstractcsv
{
    const ENCLOSURE = '"';
    const DELIMITER = ',';
    ...
    {
        $fileName = 'credit_memo_export_'.date("Ymd_His").'.csv';
