 ...
 * */
class Bluejalappeno_Orderexport_Model_Export_Invoicesitems extends Bluejalappeno_Orderexport_Model_Export_Abstractcsv
{
    const ENCLOSURE = '"';
    const DELIMITER = ',';
    ...
    {
        $fileName = 'invoice_items_export_'.date("Ymd_His").'.csv';
