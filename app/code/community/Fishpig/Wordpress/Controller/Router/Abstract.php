		...
		try {
			if ($this->_canMatchRoute()) {
				...
				if (($uri = Mage::helper('wordpress/router')->getBlogUri()) !== null) {
					Mage::dispatchEvent($this->_frontendRouterName . '_match_routes_before', array('router' => $this, 'uri' => $uri));
					...
					Mage::dispatchEvent($this->_frontendRouterName . '_match_routes_after', array('router' => $this, 'uri' => $uri));
				}
			}
		}
		catch (Exception $e) { 
