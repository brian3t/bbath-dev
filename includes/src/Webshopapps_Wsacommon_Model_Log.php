 ...
 */
class Webshopapps_Wsacommon_Model_Log extends Mage_Core_Model_Abstract
{
     ...
     * @return Mage_AdminNotification_Model_Inbox
     */
    public function parse($severity,$extension,$title,$description)
    {
