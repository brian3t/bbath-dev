 ...
 */
class Webshopapps_Wsacommon_Adminhtml_LogController extends Mage_Adminhtml_Controller_Action
{
	...
	protected function _initAction() {
        ...
        $this->loadLayout()
            ...
            ->_addBreadcrumb(Mage::helper('wsacommon')->__('WebShopApps Log'), Mage::helper('wsacommon')->__('WebShopApps Log'));
        return $this;
    }
    ...
    public function markAsReadAction()
    {
        if ($id = $this->getRequest()->getParam('id')) {
            ...
            $model = Mage::getModel('wsacommon/log')
                ->load($id);
    ...
    public function viewAction() {
		  ...
		  $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('wsacommon_adminhtml/log_view'))
            ->renderLayout();
     ...
     public function massDestroyAction()
    {
        $session = Mage::getSingleton('adminhtml/session');
            ...
            try {
               	$model = Mage::getModel('wsacommon/log')->truncate();
                $this->_getSession()->addSuccess(
