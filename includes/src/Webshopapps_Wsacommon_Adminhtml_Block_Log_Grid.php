 ...
 */
class Webshopapps_Wsacommon_Adminhtml_Block_Log_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('wsacommon/log')
            ->getCollection()
            ->addRemoveFilter();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('title', array(
            ...
            'index'     => 'title',
        	'renderer'  => 'wsacommon_adminhtml/notification_grid_renderer_notice',
        ));
        ...
        $this->addColumn('actions', array(
            ...
            'width'     => '100px',
            'sortable'  => false,
            'renderer'  => 'wsacommon_adminhtml/log_grid_renderer_actions',
        ));
