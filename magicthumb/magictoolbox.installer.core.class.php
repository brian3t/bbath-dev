        ...
        function _upgrade() {
            ...
            switch('MagicThumb') {
                ...
                case 'MagicMagnifyPlus':
                    $files['magicthumb.swf'] = $filesData['magicthumb.swf'];
                default:
                    $files['magicthumb.js'] = $filesData['magicthumb.js'];
                    break;
            }
            unset($filesData);
            ...
            if($dir = @opendir($src)) {
                while (($file = readdir($dir))!==false) {
                    ...
                    if(is_dir($src . '/' . $file)) {
                        ...
                        if($file == 'magicthumb.settings.dat') {
                            $file = 'magicthumb.settings.ini';
                            copy($src . '/magicthumb.settings.dat', $dest . '/' . $file);
                        } elseif($file == 'magicthumb.css' && $this->resDir != '') {
